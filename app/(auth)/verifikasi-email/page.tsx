...
import emailAnimation from "@/public/lottie/Login.json"; // ganti dengan lottie email kalau ada
          ...
          <div className="relative flex h-full w-full max-w-xl flex-col items-center justify-center gap-5 text-center lg:gap-6">
            <div className="space-y-4">
              ...
              <p className="mt-3 max-w-xl text-sm text-white/90 sm:text-base">
                Akun kamu sudah berhasil dibuat. Cek inbox email kamu dan klik
                tautan verifikasi untuk mulai menggunakan Remitra.
              </p>
            </div>
        ...
        >
          ...
          <div className="flex h-full w-full flex-col justify-center p-6 sm:p-8 lg:p-10">
            ...
            <p className="mt-2 text-sm text-neutral-600 dark:text-zinc-300">
              Kami telah mengirim tautan verifikasi ke email yang kamu
              daftarkan. Klik tautan tersebut untuk mengaktifkan akunmu.
            </p>
            ...
            <div className="mt-8 space-y-4">
              {[
                {
                  step: "1",
                  title: "Buka email kamu",
                  desc: "Cari email dari Remitra di inbox atau folder spam.",
                },
                {
                  step: "2",
                  title: "Klik tautan verifikasi",
                  desc: "Klik tombol atau link di dalam email untuk memverifikasi akun.",
                },
                {
                  step: "3",
                  title: "Login dan mulai pakai",
                  desc: "Setelah terverifikasi, login dan kelola kasbon UMKM kamu.",
                },
              ].map((item) => (
            ...
            <div className="mt-8 rounded-2xl border border-orange-100 bg-orange-50 p-4 dark:border-orange-900/30 dark:bg-orange-950/20">
              <p className="text-sm text-orange-700 dark:text-orange-300">
                ...
                <span className="font-semibold">
                  Cek folder spam atau tunggu beberapa menit.
                </span>
              </p>
            </div>
            ...
            <Link
              href="/login"
              className="mt-6 inline-flex w-full items-center justify-center rounded-2xl border border-orange-200 bg-white px-6 py-3 text-sm font-semibold text-orange-600 transition hover:bg-orange-50 dark:border-orange-900/40 dark:bg-zinc-900 dark:text-orange-400 dark:hover:bg-orange-950/20"
            >
